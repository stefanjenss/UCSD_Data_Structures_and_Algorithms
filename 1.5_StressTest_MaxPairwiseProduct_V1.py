...
def maxPairwiseProductFast(n, array):
    ...
    for i in range(n):
        ...
        """
        THE ERROR LIES ABOVE:
            Instead of checking whether the value at i is equal to the value at index1, we need to make sure that
            i itself is not equal to index1. -> Change is made in 1.6 code
        """    
